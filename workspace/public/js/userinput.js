...
$(document).ready(function() {  
  ...
  //   var witurl = 'https://api.wit.ai/message?v=20151014&q=' + question;
  //   $.ajax({
  //     url: witurl,
      
  //     success: sendToScreen,
  //     headers: { 'Authorization': 'Bearer VUJSKVJZPDWBSXEIYQN6OT36XNOLGREJ'}
  //     });
  // }
  
// resize the image first. This doesn't seem to work on mobile though...
...
//         		formData.append("imgFile", canvas.mozGetAsFile(imgName));
...
//         			  sess.publish('com.selfridges.uploadimage', [response], {}, { acknowledge: true}).then(
...
// });
  ...
  function sendSpeechToScreen(response){
    sess.publish('com.selfridges.speech', [response]);
  ...
  var mic = new Wit.Microphone(document.getElementById("microphone"));
    ...
    mic.connect("J2GFYW4GVPLAMZDCIIDPNS5IXS7SPJCM");
